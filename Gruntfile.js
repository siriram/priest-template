// Generated on 2013-10-24 using generator-bootstrap-less 3.0.3
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch:         {
      recess:     {
        files: ['<%= yeoman.app %>/styles/source/{,*/}*.less'],
        tasks: ['recess']
      },
      livereload: {
        files: [
    ...
    recess:        {
      dist: {
        ...
        files:   {
          '<%= yeoman.app %>/styles/css/main.css': ['<%= yeoman.app %>/styles/source/main.less']
        }
      }
    },
